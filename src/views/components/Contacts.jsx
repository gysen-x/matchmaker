          ...
          <ul className="contacts__list list-reset flex">
            <li className="contacts__item contacts__item-adress flex">
              ...
              <p className="contacts__item-text">
                Gang Tanjung Mekar, Jimbaran, South Kuta, Badung Regency, Bali 80361
            ...
            <li className="contacts__item contacts__item-phone flex">
              ...
              <div className="contacts__link-wrapper">
                <a className="contacts__item-link" href="tel:+79876543210">+7 (987) 654-32-10</a>
                <a className="contacts__item-link" href="tel:+71234567890">+7 (123) 456-78-90</a>
              </div>
            </li>
            <li className="contacts__item contacts__item-email flex">
              <strong className="contacts__item-caption ">Email</strong>
              <div className="contacts__link-wrapper">
                <a className="contacts__item-link" href="mailto:example@example.com">example@example.com</a>
                <a className="contacts__item-link" href="mailto:support@example.com">support@example.com</a>
              </div>
            </li>
          </ul>
        </adress>
