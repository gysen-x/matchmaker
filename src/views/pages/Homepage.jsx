          ...
          <ul className="slider__list">
            <li>
              ...
              <div className=" content">
                <h2>Футбол</h2>
                <a className="slider__link" href="#">Найти игру</a>
              </div>
            </li>
            <li>
        ...
        <div className="bottom">
          <div className="bottom__text">
            ...
            <p className="bottom__paragraph">
              Как часто вы оказывались в ситуации когда в последний момент один из игроков
              заболел и не может участвовать в игре? Бывало ли такое что из-за нехватки игроков приходилось отменять игру
              или турнир?
            </p>
          </div>
          ...
          <div className="bottom__text">
            ...
            <p className="bottom__paragraph">
              Мышцы человека укрепляются, организм человека приобретает выносливость.
              Ткани и клетки всего организма снабжаются кислородом и укрепляется сердце с сосудистой системой.
            </p>
          </div>
          <div className="bottom__text">
            <h1 className="bottom__title">🎯 Наше решение</h1>
            <p className="bottom__paragraph">
              Наш сайт решает эти проблемы. Вы можете как найти уже существующую игру и принять в
              ней участие, либо создать
